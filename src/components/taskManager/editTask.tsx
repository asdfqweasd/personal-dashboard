...
const EditTask: React.FC<TaskFormProps> = ({ editTodo, task }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="text-white end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 "
      >
        Update Task
      </button>
    </form>
